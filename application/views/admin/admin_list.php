...
<html lang="en">
	...
	<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed">	
        ...
        <div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
            ...
            <div class="container-xxl d-flex align-items-center justify-content-between" id="kt_header_container">
                ...
                <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-5 pt-5 pb-lg-2" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_header_container', lg: '#kt_header_container', xl: 'kt_content_container'}">
                    <!--begin::Heading-->
                    <h1 class="text-dark fw-bold my-0 fs-2">Daftar Admin</h1>
                    <!--end::Heading-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-line text-muted fw-bold fs-base my-1">
                        ...
                        <li class="breadcrumb-item text-dark">Daftar Admin</li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                <!--end::Page title=-->
                        ...
                        <div class="card card-xl-stretch mb-5 mb-xl-8">
                            <div class="card-header border-0 pt-5">
                                <h3 class="card-title align-items-start flex-column">
                                    ...
                                    <span class="text-muted mt-1 fw-bold fs-7">Daftar Admin</span>
                                </h3>
                                    ...
                                    <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                                        <thead>
                                            <tr class="fw-bolder text-muted">
                                                ...
                                                <th class="min-w-140px">No Handphone</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="#" class="text-dark fw-bolder text-hover-primary d-block fs-6"><?php echo $s['nama'] ?></a>
                                                    <span class="text-muted fw-bold text-muted d-block fs-7"><?php echo $s['username'] ?></span>
                                                </td>
                                                <td>
                                                    <?php echo $s['no_hp'] ?>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-end flex-shrink-0">
                                                        <a href="#" data-bs-toggle="modal" data-bs-target="#update_admin<?php echo $s['id'] ?>" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                                            <span class="svg-icon svg-icon-3">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                                        ...
                                                        <a href="#" data-bs-toggle="modal" data-bs-target="#hapus_admin<?php echo $s['id'] ?>" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
                                                            <span class="svg-icon svg-icon-3">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
        ...
        <?php foreach($admin_list as $sm) { ?>
		<div class="modal fade" id="update_admin<?php echo $sm['id'] ?>" tabindex="-1" aria-hidden="true">
					...
					<div class="modal-body py-lg-10 px-lg-10">
						<div class="stepper stepper-pills stepper-column d-flex flex-column flex-xl-row flex-row-fluid" id="kt_modal_create_app_stepper">
							<div class="flex-row-fluid py-lg-5 px-lg-15">
								<form class="form" novalidate="novalidate" action="<?php echo base_url() ?>admin/admin_update_proses" method="post" enctype="multipart/form-data">
                                    <div class="row">
                                        <!-- <div class="col-4">
                                            <div class="w-100">
                                        ...
                                        <div class="col-6">
                                            <div class="w-100">
                                                <div class="fv-row mb-10">
                                                    ...
                                                    <input type="text" class="form-control form-control-lg form-control-solid" name="username" value="<?php echo $sm['username'] ?>"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="w-100">
                                                <div class="fv-row mb-10">
                                                    ...
                                                    <input type="text" class="form-control form-control-lg form-control-solid" name="password" value="<?php echo $sm['password'] ?>"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="w-100">
                                                <div class="fv-row mb-10">
                                                    <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                                                        ...
                                                        <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Nama Admin.."></i>
                                                    </label>
                                                    <input type="text" class="form-control form-control-lg form-control-solid" name="nama" value="<?php echo $sm['nama'] ?>"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="w-100">
                                                <div class="fv-row mb-10">
                                                    ...
                                                    <input type="text" class="form-control form-control-lg form-control-solid" name="no_hp" value="<?php echo $sm['no_hp'] ?>"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="w-100">
                                                <div class="fv-row mb-10">
                                                    ...
                                                    <textarea name="alamat" class="form-control form-control-lg form-control-solid" rows="3"><?php echo $sm['alamat'] ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
		...
		<div class="modal fade" id="hapus_admin<?php echo $sm['id'] ?>" tabindex="-1" aria-hidden="true">
			<div class="modal-dialog modal-dialog-centered mw-900px">
				<div class="modal-content">
					<div class="modal-header">
						<h2>
					...
					<div class="modal-body py-lg-10 px-lg-10">
						<div class="stepper stepper-pills stepper-column d-flex flex-column flex-xl-row flex-row-fluid" id="kt_modal_create_app_stepper">
							<div class="flex-row-fluid py-lg-5 px-lg-15">
                                <div class="w-100">
                                    <p>Apakah Anda Yakin akan menghapus Admin <strong>"<?php echo $sm['nama'] ?>"</strong> ?</p>
                                </div>
                                <div class="d-flex flex-stack pt-10">
                                    <div class="me-2">
                                    ...
                                    <div>
                                        <a href="<?php echo base_url('admin/admin_hapus_proses/'.$sm['id']) ?>" class="btn btn-lg btn-primary">
                                            <span class="indicator-label">
                                                Ya, Hapus!
                                            </span>
                                            <span class="indicator-progress">
